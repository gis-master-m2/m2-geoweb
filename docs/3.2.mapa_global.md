...
!!! tip "Estilos mapbox y galeria de estilos"
    [https://docs.mapbox.com/api/maps/styles/](https://docs.mapbox.com/api/maps/styles/){target=_blank}

    [https://www.mapbox.com/gallery](https://www.mapbox.com/gallery){target=_blank}
...
!!! note "En versiones V12 de estilos de Mapbox la proyeccion globe está por defecte"
