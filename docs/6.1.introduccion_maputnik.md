...
* Seleccionaremos el estilo gris de OpenICGC
...
!!! question "¿Ponemos la proyección globe?"


!!! question "Creamos archivo js/carriles.js" y funcion "addCarriles() movemos el código d añadir los carriles?"
