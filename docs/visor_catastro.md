...
* Si trabajamos con 3D el evento click sobre la capa no funciona muy bien , podríamos programar el evento click sobre el mapa, obtener los vectores de todas las capas y filtrar por la capa que nos interesa.
