...
* Mapbox.com no ofrece opciones como servidor para hospedar y convertir datos a Vector-Tiles
...
* En la specificación de Style de Mapbox los polígonos tienen tienen el "paint property" "fill-extrusion" dónde que puedo cambiar de color y extrudir geometrias
...
!!! warning "En este ejemplo y en adelante vamos a eutilizar el archivo css **/geoweb/css/estilobase.css**"
