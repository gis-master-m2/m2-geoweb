  <img src="https://es.wikipedia.org/wiki/Aplicaci%C3%B3n_web_progresiva#/media/Archivo:Progressive_Web_Apps_Logo.svg" width="100">     

### Progressive web application (PWA)

Una aplicación web progresiva (PWA) es un tipo de aplicación web que ofrece una experiencia similar a una aplicación a los usuarios. Combina lo mejor de las aplicaciones web y nativas, proporcionando a los usuarios una experiencia fluida y rápida en sus dispositivos.
