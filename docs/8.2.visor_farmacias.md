...
#### Paso 6: Control geocoder como buscador interno
 ...
 - Creamos variable **farmaciasGeoJSON** reutilizamos funcion **enviarPeticion()** para obtener features del geojson de farmacias

```html hl_lines="10 11 24 43-48 55-58"
<html>
...
#### Paso 7: Dentro de *js/farmacias.js* creamos funcion para buscar en el GeoJson
