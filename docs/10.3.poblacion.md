...
```
#### Paso 3: Creamos dos variables globales y llamamos a la funcion *getFeaturesFGB* cada vez que movemos mapa



```html hl_lines="20 26-27 53-69"
<html>
...
Activamos herramientas de dibujar Puntos, Polígonos y Borrar
