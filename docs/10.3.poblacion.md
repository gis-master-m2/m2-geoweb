...
Implementaremos funciones para llamar al flatGeobuf de forma genérica y por caja de coordenadas
...
- Llamos la función getFeaturesFGB des de los eventos del maps
...
```html hl_lines="71 87-93 101-104"
<html>
